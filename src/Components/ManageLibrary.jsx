...
const ManageLibrary = () => (
  <section id="mobile" className={layout.section}>
    <div className={layout.sectionInfo}>
      <ScrollReveal.div delay={0.4}>
        <h2 className={styles.heading2}>Easily manage your game library</h2>
        </ScrollReveal.div>
        <ScrollReveal.div delay={0.8}>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Haze makes it easy to keep track of your games and stay up-to-date
          with our intuitive mobile app. Our modern interface lets you organize
          your library and quickly find the games you want to play.
        </p>
      <Button styles={`mt-10`} />
      </ScrollReveal.div>

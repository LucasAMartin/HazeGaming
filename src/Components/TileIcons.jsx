...
const TileIcons = () => (
    <div className="flex flex-wrap absolute top-2 left-2 gap-2">
      <div className="rounded-lg bg-pink-500 px-2">
        <div className="flex flex-row gap-2 flex-nowrap text-white text-[12px] font-poppins text-center items-center pl-1 pr-1">
